...
const PIPE_STAGES = [
  { key: 'sent', label: 'To contact', accent: 'var(--status-info)', next: 'Send / drop the letter' },
...
const PIPE_STATUS = {
  ...
  listing_signed: { label: 'Listing Signed', status: 'good' },
                      ...
                      <div key={g.representative_id} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 11, padding: '12px 13px', boxShadow: 'var(--shadow-card)' }}>
                        ...
                        <div style={{ display: 'flex', gap: 6, marginTop: 10 }}>
                          ...
                          <Select value="" size="sm" onChange={ev => { if (!ev.target.value) return; setActionModal({ id: g.representative_id, status: ev.target.value }); ev.target.value = '' }}
                            options={[{ value: '', label: 'Move…' }, { value: 'responded', label: 'Responded' }, { value: 'appraisal_booked', label: 'Appraisal' }, { value: 'listing_signed', label: 'Won' }, { value: 'no_response', label: 'No response' }]} />
                        </div>
                      </div>
                    ))}
